...
const ShiftSwapModal = ({ shift, onClose }) => {
    ...
    const { shifts: dayShifts, loading: shiftsLoading, swapShifts } = useShifts(
        new Date(shift.date),
        new Date(shift.date)
    );
            ...
            <div className="modal-content">
                ...
                <form onSubmit={handleSubmit} className="swap-form">
                        ...
                        {shiftsLoading ? (
                            ...
                            <div className="swap-options">
                                {availableSwaps.map(s => (
                                    <label key={s.id} className={`swap-option ${targetShiftId === s.id ? 'selected' : ''}`}>
                                        <input
                                            type="radio"
                                            name="targetShift"
                                            value={s.id}
                    ...
                    <div className="modal-actions">
                        ...
                        >
                            {isSubmitting ? <span className="spinner-sm"></span> : <FiRefreshCw />}
                            Confirm Swap
                        </button>
                    </div>
                </form>
